export function reconciliationError(message: string) {
  const messages: Record<string, string> = {
    ...
    statement_import_has_booked_payments: "Z tohoto výpisu už jsou zaúčtované platby, proto ho nelze zahodit. Nejdřív uvolněte jejich přiřazení.",
    statement_import_not_discardable: "Import není ve stavu, ve kterém by šel zahodit.",
    statement_import_not_found: "Import už neexistuje. Načtěte aktuální stav.",
