  ...
  public: {
    Tables: {
      ...
      bank_statement_imports: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["bank_statement_imports"]["Insert"]
        >;
        Relationships: [];
      };
      bank_statement_entries: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["bank_statement_entries"]["Insert"]
        >;
        Relationships: [];
      };
      bank_payment_allocations: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["bank_payment_allocations"]["Insert"]
        >;
        Relationships: [
          {
      ...
      counterparty_payment_accounts: {
        ...
        Update: Partial<
          Database["public"]["Tables"]["counterparty_payment_accounts"]["Insert"]
        >;
        Relationships: [];
      };
