...
export default function NewInvoicePage() {
  ...
  return <AppFrame><header className="section-header"><div><Link href="/invoices" className="back-link"><Icon name="arrow-left"/>Zpět na faktury</Link><p>RUČNÍ ZADÁNÍ</p><h1>Nová vydaná faktura</h1><span>Zapište fakturu, jejíž úhradu má firma sledovat.</span></div><Link href="/invoices/import" className="btn secondary"><Icon name="upload"/>Raději importovat dokument</Link></header><InvoiceForm onSubmit={create}/></AppFrame>;
}
